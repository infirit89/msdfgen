...
INCLUDES += -Iinclude -Icore -Iext -Ifreetype/include
FORCE_INCLUDE +=
...
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -g -Wno-4005 -Wno-4267
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -g -std=c++11 -Wno-4005 -Wno-4267
LIBS += freetype/bin/Debug-linux-x86_64/libFreetype.a
LDDEPS += freetype/bin/Debug-linux-x86_64/libFreetype.a
...
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -Wno-4005 -Wno-4267
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -std=c++11 -Wno-4005 -Wno-4267
LIBS += freetype/bin/Release-linux-x86_64/libFreetype.a
LDDEPS += freetype/bin/Release-linux-x86_64/libFreetype.a
